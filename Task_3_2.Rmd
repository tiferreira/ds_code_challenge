...
elect[,expandmaxdate:=as.Date(ifelse(is.na(CompletionDate) | CompletionDate>max(CreationDate),max(CreationDate) + 1,CompletionDate),origin="1970-01-01")]
